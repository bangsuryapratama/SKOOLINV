            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <div class="card-title mb-0">Data Peminjaman</div>
                  <div>
                    <a href="{{ route('peminjaman.export') }}" class="btn btn-sm btn-danger me-2">
                      ...
                      <table class="table table-striped table-bordered" id="example" style="width: 100%; table-layout: auto;">
                        <thead>
                          <tr>
                              ...
                              <th style="width: 150px;">Kode Peminjam</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <form action="{{ route('peminjaman.destroy', $data->id) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus data ini?');" style="display: inline-block;">
                                <a href="{{ route('peminjaman.show', $data->id) }}" class="btn btn-sm btn-warning" title="Lihat Detail">
                                  <i class="fa fa-eye"></i>
                                </a>
                                <a href="{{ route('peminjaman.edit', $data->id) }}" class="btn btn-sm btn-primary" title="Edit">
                                  <i class="fa fa-pen"></i>
                                </a>
                                @csrf
                                @method('DELETE')
