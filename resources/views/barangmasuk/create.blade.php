          ...
          <div class="main-header">
            ...
            <!-- End Navbar -->
                    ...
                    <div class="page-inner">
                        ...
                        <h3 class="fw-bold mb-3">Menambahkan Data Barang Masuk</h3>
                        </div>
                        <div class="row">
                        <div class="col-12">
                            <div class="card">
                    <div class="card-body">
                        <h4 class="card-title" style="color: #000" >Data Barang Masuk</h4>
                        ...
                        <form action="{{ route('barangmasuk.store') }}" method="POST" enctype="multipart/form-data" class="forms-sample">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tglmasuk') is-invalid @enderror" name="tglmasuk"
                                    value="{{ old('tglmasuk') }}" placeholder="Tanggal Masuk" id="Tgl Masuk"
                                    style="color: #000; background-color: #f5f5f5;">
                                @error('tglmasuk')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
