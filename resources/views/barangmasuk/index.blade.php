                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center">
                              <form action="{{ route('barangmasuk.destroy', $bm->id) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus data ini?');" style="display: inline-block;">
                                <a href="{{ route('barangmasuk.show', $bm->id) }}" class="btn btn-sm btn-warning" title="Lihat Detail">
                                  <i class="fa fa-eye"></i>
                                </a>
                                <a href="{{ route('barangmasuk.edit', $bm->id) }}" class="btn btn-sm btn-primary" title="Edit">
                                  <i class="fa fa-pen"></i>
                                </a>
                                @csrf
                                @method('DELETE')
